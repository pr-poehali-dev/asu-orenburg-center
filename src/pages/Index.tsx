        ...
        <section id="gallery" className="py-20 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Оренбургский клинический перинатальный центр
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  src: '/img/057e73f2-b679-4d1e-be1c-30fc65b036fe.jpg',
                  title: 'Здание центра',
                  description: 'Современное здание перинатального центра'
                },
                {
                  src: '/img/dd4f5596-cca9-4313-982e-38d2e42e8c7f.jpg',
                  title: 'Холл и регистратура',
                  description: 'Комфортная зона ожидания для посетителей'
                },
                {
                  src: '/img/c89266ee-1087-4556-ae43-220291160643.jpg',
                  title: 'Медицинские кабинеты',
                  description: 'Современное оснащение медицинских отделений'
                }
              ].map((image, idx) => (
                <Card 
                  key={idx} 
